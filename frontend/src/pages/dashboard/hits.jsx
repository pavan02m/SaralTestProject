    ...
    <div className="mt-12">
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          ...
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["Name", "Started At", "status","onboarded", "Started On", "Upgraded On", "Last Active On"].map((el) => (
                  <th
                    key={el}
            ...
            <tbody>
              {userData.map(
                ({ first_name, last_name, email, trialStartedAt, subscriptionStatus, upgradedAt, lastSeen }, key) => {
                  ...
                  return (
                    <tr key={name}>
                      ...
                      <td className={className}>
                        <Typography className="text-xs font-semibold text-blue-gray-600">
                          {upgradedAt ? new Date(upgradedAt).toLocaleDateString('en-GB') : ""}
                        </Typography>
                      </td>
                      <td className={className}>
                        <Typography className="text-xs font-semibold text-blue-gray-600">
